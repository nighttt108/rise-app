  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg-void)', display: 'flex', flexDirection: 'column' }}>
      ...
      <header style={{
        ...
        height: '56px', background: 'rgba(8,10,15,0.9)',
        ...
        <span style={{
          ...
          color: 'var(--accent-purple)', letterSpacing: '0.15em'
        }}>RISE</span>
      </header>

      {/* Main content */}
      <main style={{ flex: 1, paddingTop: '56px', paddingBottom: '72px', overflowY: 'auto' }}>
        <Outlet />
      </main>
      ...
      <nav style={{
        ...
        height: '64px', background: 'rgba(13,17,23,0.95)',
        backdropFilter: 'blur(12px)',
